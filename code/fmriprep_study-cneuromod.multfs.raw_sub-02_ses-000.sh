...
#SBATCH --output=/scratch/tmp/multfs.fmriprep/code/fmriprep_study-cneuromod.multfs.raw_sub-02_ses-000.out
#SBATCH --error=/scratch/tmp/multfs.fmriprep/code/fmriprep_study-cneuromod.multfs.raw_sub-02_ses-000.err
#SBATCH --time=8:00:00
...
flock --verbose /data/neuromod/ria-sequoia/alias/cneuromod.multfs.fmriprep/.datalad_lock datalad clone ria+file:///data/neuromod/ria-sequoia#~cneuromod.multfs.fmriprep $LOCAL_DATASET
cd $LOCAL_DATASET
